  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-white flex flex-col">
      ...
      <div className="mt-14 mx-40  h-96 mb-4   flex flex-raw">
        <div className=" px-1 h-96 mb-4  w-full flex flex-col">
          <img
      ...
      <div className="mx-40 flex flex-row flex-grow">
          ...
          <div className="flex flex-col flex-grow text-left">
            ...
            <div className="mb-4   flex flex-row">
              <div className="w-9/12 mb-4  ">
                ...
                <p className="mb-2">
                  <FaStar className="inline-block mr-2 ml-2 text-yellow-400" />
                  {rating}
                </p>
              </div>
              <div
        ...
        <div className="  w-full sm:w-2/5 flex flex-col md:flex-col  justify-between mb-8 bg-white  items-center">
          {/* Reviews */}
          <div className="my-5 md:mb-0 md:w-full md:h-auto   items-center">
            <img
              src={decodeURIComponent(image)}
              alt={name}
              className="p-1 rounded-2xl object-cover shadow-md hover:shadow-lg transition duration-300 w-full h-3/4"
            />
          </div>
          <div className="my-5 md:mb-0 md:w-full md:h-auto   items-center">
            <img
              ...
              <div className="p-4">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mt-4">
                    <button
                      type="submit"
                      className="rounded-sm px-4 py-2 bg-yellow-500 text-white  hover:bg-yellow-600 focus:outline-none"
                    >
                      Submit
                    </button>
                  </div>
